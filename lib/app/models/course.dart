import 'package:mobile_app/app/models/section.dart';
import 'package:mobile_app/app/models/user.dart';
...
class Course {
  ...
  Course({
    ...
    int? totalRegister = 0,
        ...
        _totalRegister = totalRegister;

  Course.fromJson(Map<String, dynamic> json)
      : _id = json['id'],
        _title = json['title'],
        _video = json['video'],
        _scoreRating = json['scoreRating']?.toDouble() ?? 0.0,
        _thumbnail = json['thumbnail'],
        _author = User.fromJson(json['author']),
        _sections = (json['sections'] as List)
        ...
        _totalRegister = json['totalRegister'] ?? 0,
        categories = (json['categories'] as List<dynamic>?)
            ?.map<String>((category) => category.toString())
            .toList();
  ...
  set scoreRating(double value) =>
      _scoreRating = value > 0 ? value : _scoreRating;
  set thumbnail(String? value) =>
      _thumbnail = value?.isNotEmpty == true ? value : _thumbnail;
  set author(User value) => _author = value;
  set sections(List<Section> value) =>
      _sections = value.isNotEmpty ? value : _sections;
  set description(String? value) =>
      _description = value?.isNotEmpty == true ? value : _description;
  set createdAt(DateTime? value) => _createdAt = value!;
  set totalLessons(int? value) =>
      _totalLessons = value! > 0 ? value : _totalLessons;
  set price(int? value) => _price = value! > 0 ? value : _price;
  set totalDuration(int? value) =>
      _totalDuration = value! > 0 ? value : _totalDuration;
  set totalRegister(int? value) =>
      _totalRegister = value! >= 0 ? value : _totalRegister;
}
