...
import com.dreamchasers.recoverbe.call.CallRequest;
import com.dreamchasers.recoverbe.call.CallResponse;
...
//    @MessageMapping("/comments/courses/{courseId}/lessons/{lessonId}")
//    @SendTo("/lessons/{lessonId}/comments")
//    public Object commentInCourse(@Payload CommentDTOInCourse comment, @DestinationVariable UUID lessonId, @DestinationVariable UUID courseId) {
